...
export const Appbar = () => {
    return (
        <div className="flex p-1 items-center">
            ...
            <div className="sm:basis-2/4"></div>
            <div className="basis-1/4 flex flex-row-reverse items-center justify-start gap-3">
                <div className="w-9 h-10 ">
                    <Avatar name="Aniket" size={{ w: 9, h: 9 }}></Avatar>
                </div>
                <button>
                    <img className="w-6 h-6"src="https://img.icons8.com/?size=48&id=eMfeVHKyTnkc&format=png" alt="" />
                </button>
                <button className="rounded-2xl bg-slate-100 px-2 py-1 ">Write it</button>
            </div>
        </div>
    )
}